export default async function middleware(request: Request) {
  ...
  const isBot = /facebookexternalhit|twitterbot|whatsapp|telegrambot|slackbot|googlebot|bingbot|linkedinbot|yandex|baidu|pinterest|skypeuripreview/i.test(userAgent);
